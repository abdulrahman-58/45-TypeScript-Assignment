...
let friends: string[] = [`Abdullah`,`Ibrahim`,`Haseeb`,`Tameem`];
...
let friends: string[] = [`Abdullah`,`Ibrahim`,`Haseeb`,`Tameem`];
let message = `You are invideted on dinner tomorrow `;
for(let i=0; i<friends.length; i++){
...
// task 13
// Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
let transportation: string[] = [`car`, `bike`, `train`, `aeroplane`];
...
let guest_list: string[] = [`Abdullah`,`Ibrahim`,`Haseeb`,`Talha`];
...
let not_coming: string = `Talha`;
let new_guest: string = `Tameem`;
...
let places: string[] = [`Islamabad`,`Makka`,`Madina`,`Palestine`,`Kashmir`];
...
let programming_languages: string[] = ["Python","JavaScript","Typescript","C++","Java"];
console.log("Some programming languages are: ",programming_languages);

// task21
//They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
// Datatype of book object
interface book{
    title : string,
    author : string,
...
// Print Book
console.log(`Book name: ${book.title} written by: ${book.author}, published in ${book.yearPublished}`);
...
// Creating array
let fruits: string[] = [`mangoes`,`banana`,`oranges`,`apple`];
...
console.log("Equility test with strings: ", ("Apple"as string) === "Banana");
// Tests for inequality
console.log("Inequility test with strings: ", ("Apple" as string) !== "Orange");
...
console.log("Equility test with numbers: ", (26 as number) === 36);
// Numerical tests involving inequality
console.log("Inequility test with numbers: ", (26 as number) !== 46);
...
console.log("Or operator test: ", (5 as number)===8 || 2 > 5);
// Test whether an item is in a array
const fruits: string[] = ['Mangoes','Banana','Orange'];
...
let current_users = ['TaHa', 'DaNiyal', 'SaLeem', 'Hamza', 'john'];
...
new_users.forEach(newUsername =>{
    ...
    if (current_users.map(c_user => c_user.toLowerCase()).includes(lowerCase)){
        console.log(`The username ${newUsername} is not valid. Please write a different username`);
    }
    else{
...
let magician: string[] = ['Harry pottor', 'Hermione', 'Ron Wasley','Albus Dumbledore'];
...
function createCar(maufacture: string, model: string, optional: Record<string, any>): car{
    return{
      maufacture ,
      model,
      ...optional 
